      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-black mb-8 text-slate-900  leading-tight">Restons <span className="text-emerald-600 underline underline-offset-8">Connectés</span></h3>
            
            <p className="text-slate-500  text-sm md:text-base mb-12 leading-relaxed max-w-md font-medium">
            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-slate-800 ">moumenmalsah@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-slate-800 ">Maroc</p>
                </div>
              </div>
            </div>
