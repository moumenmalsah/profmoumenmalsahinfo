...
import { Menu, X, BookOpen, User, Briefcase, GraduationCap, Mail, Globe, Moon, Sun } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 flex items-center gap-3">
            ...
            <div>
              <h1 className={`text-lg font-bold leading-tight ${scrolled ? 'text-slate-900 dark:text-white' : 'text-slate-900'}`}>Malsah Moumen</h1>
            ...
            <div className="px-4 py-6 space-y-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className="flex items-center gap-4 px-4 py-3 rounded-xl text-slate-700 dark:text-slate-200 hover:bg-brand-primary hover:text-white transition-all group"
                >
